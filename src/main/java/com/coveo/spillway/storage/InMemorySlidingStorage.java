...
public class InMemorySlidingStorage implements LimitUsageStorage
{
  ...
  private void removeExpiredEntries()
  {
    ...
    Set<Instant> expiredEntries = map.keySet()
                                     .stream()
                                      ...
                                      LimitKey limitKey)
  {
    ...
    return map.entrySet()
              ...
              .peek(entry2 -> System.out.println(entry2.getKey().toString() + " : " + entry2.getValue().get()))
  ...
  private boolean limitKeysEquals(LimitKey first,
                                 LimitKey second)
  {
    return first.getResource() == second.getResource() && first.getLimitName() == second.getLimitName()
